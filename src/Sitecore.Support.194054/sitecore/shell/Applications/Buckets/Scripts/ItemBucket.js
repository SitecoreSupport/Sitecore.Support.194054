...
function Initialization() {
  ...
  //  });
    ...
    // Support 194054 moved this line to be after EstablishViews(): !SC.searchBoxViewModel.isSearchEmpty() && SC.searchBoxViewModel.startSearchCallback();
  ...
  $j("#results").on("click", ".pageLink", function () {
	...
	!SC.searchBoxViewModel.isSearchEmpty() && SC.searchBoxViewModel.startSearchCallback(); // Support 194054
